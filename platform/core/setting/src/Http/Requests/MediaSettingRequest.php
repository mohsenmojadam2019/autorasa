...
//
//            'media_s3_access_key_id' => ['nullable', 'string', 'required_if:media_driver,s3'],
//            'media_s3_secret_key' => ['nullable', 'string', 'required_if:media_driver,s3'],
//            'media_s3_default_region' => ['nullable', 'string', 'required_if:media_driver,s3'],
//            'media_s3_bucket' => ['nullable', 'string', 'required_if:media_driver,s3'],
//            'media_s3_url' => ['nullable', 'string', 'required_if:media_driver,s3'],
//            'media_s3_endpoint' => ['nullable', 'string'],
//            'media_s3_use_path_style_endpoint' => $onOffRule = new OnOffRule(),
//
