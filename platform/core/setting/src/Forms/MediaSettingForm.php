...
//                TextField::class,
//                TextFieldOption::make()
//                    ->label(trans('core/setting::setting.media.s3_access_key_id'))
//                    ->value(setting('media_s3_access_key_id'))
//                    ->placeholder('Ex: AKIAIKYXBSNBXXXXXX')
//            )
//            ->add(
//                'media_s3_secret_key',
//                TextField::class,
//                TextFieldOption::make()
//                    ->label(trans('core/setting::setting.media.s3_secret_key'))
//                    ->value(setting('media_s3_secret_key'))
//                    ->placeholder('Ex: +fivlGCeTJCVVnzpM2WfzzrFIMLHGhxxxxxxx')
//            )
//            ->add(
//                'media_s3_default_region',
//                TextField::class,
//                TextFieldOption::make()
//                    ->label(trans('core/setting::setting.media.s3_default_region'))
//                    ->value(setting('media_s3_default_region'))
//                    ->placeholder('Ex: ap-southeast-1')
//            )
//            ->add(
//                'media_s3_bucket',
//                TextField::class,
//                TextFieldOption::make()
//                    ->label(trans('core/setting::setting.media.s3_bucket'))
//                    ->value(setting('media_s3_bucket'))
//                    ->placeholder('Ex: botble')
//            )
//            ->add(
//                'media_s3_url',
//                TextField::class,
//                TextFieldOption::make()
//                    ->label(trans('core/setting::setting.media.s3_url'))
//                    ->value(setting('media_s3_url'))
//                    ->placeholder('Ex: https://s3-ap-southeast-1.amazonaws.com/botble')
//            )
//            ->add(
//                'media_s3_endpoint',
//                TextField::class,
//                TextFieldOption::make()
//                    ->label(trans('core/setting::setting.media.s3_endpoint'))
//                    ->value(setting('media_s3_endpoint'))
//                    ->placeholder(trans('core/setting::setting.media.optional'))
//            )
//            ->add(
//                'media_s3_use_path_style_endpoint',
//                SelectField::class,
//                SelectFieldOption::make()
//                    ->label(trans('core/setting::setting.media.use_path_style_endpoint'))
//                    ->choices([
...
//                        1 => trans('core/base::base.yes'),
//                    ])
//                    ->selected(setting('media_s3_use_path_style_endpoint'))
//            )
//            ->addCloseCollapsible('media_driver', 's3')
