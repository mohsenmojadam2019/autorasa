...
return [
    ...
    'default_upload_folder' => env('media'),
    'default_upload_url' => env('AWS_URL'),
//    'default_upload_folder' => env('RV_MEDIA_DEFAULT_UPLOAD_FOLDER'),//local
//    'default_upload_url' => env('RV_MEDIA_DEFAULT_UPLOAD_URL'),//local
