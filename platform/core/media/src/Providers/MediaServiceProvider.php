...
//                case 's3':
//                    RvMedia::setS3Disk([
//                        'key' => $setting->get('media_s3_access_key_id', $config->get('filesystems.disks.s3.key')),
//                        'secret' => $setting->get('media_s3_secret_key', $config->get('filesystems.disks.s3.secret')),
//                        'region' => $setting->get('media_s3_default_region', $config->get('filesystems.disks.s3.region')),
//                        'bucket' => $setting->get('media_s3_bucket', $config->get('filesystems.disks.s3.bucket')),
//                        'url' => $setting->get('media_s3_url', $config->get('filesystems.disks.s3.url')),
//                        'endpoint' => $setting->get('media_s3_endpoint', $config->get('filesystems.disks.s3.endpoint')) ?: null,
//                        'use_path_style_endpoint' => (bool) $setting->get('media_use_path_style_endpoint', $config->get('filesystems.disks.s3.use_path_style_endpoint')),
//                    ]);
//
//                    break;
                case 'r2':
