...
class BehpardakhtController extends BaseController
{
    public function getPaymentStatus(Request $request, BaseHttpResponse $response)
    {
        do_action('payment_before_making_api_request', BEHPARDAKHT_PAYMENT_METHOD_NAME, []);

        $result = app(BehpardakhtGateway::class)->verifyPayment($request);

        do_action('payment_after_api_response', BEHPARDAKHT_PAYMENT_METHOD_NAME, [], $result);
        ...
        do_action(PAYMENT_ACTION_PAYMENT_PROCESSED, [
            ...
            'payment_channel' => BEHPARDAKHT_PAYMENT_METHOD_NAME,
