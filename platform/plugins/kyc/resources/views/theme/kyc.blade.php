    ...
    <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
        <x-core::icon name="ti ti-plus" style="font-size: 12px; color: #fff;" />
                                    ...
                                    <button
                                        ...
                                        type="button"
                                        onclick="submitKYC()"
                                        style="width: 338px; height: 40px; left: 26px; border-radius: 12px !important; background-color: #0d6efd; border-color: #0d6efd; color: white;"
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 12px;">
                <div class="modal-body text-center py-4">
                    ...
                    <p class="text-muted small mb-3">لطفاً فایلی با حجم کمتر از ۱۰ مگابایت انتخاب کن.</p>
