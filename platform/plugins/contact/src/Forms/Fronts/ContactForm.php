...
//###
                CheckboxFieldOption::make()
                    ->label(
                        ($privacyPolicyUrl = theme_option('term_and_privacy_policy_url'))
                            ? __('با :link موافقم', [
                            'link' => Html::link($privacyPolicyUrl, __('قوانین و سیاست حریم خصوصی'), attributes: ['class' => 'text-decoration-underline', 'target' => '_blank'])
                        ])
                            : __('با قوانین و سیاست حریم خصوصی موافقم')
                    )
