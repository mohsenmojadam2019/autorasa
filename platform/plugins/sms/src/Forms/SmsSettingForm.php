            ...
            ->when(Guard::getGuard(), function (FormAbstract $form) {
                $form
                    ...
                    ->add(
                        ...
                        TextareaField::class,
                        TextareaFieldOption::make()
                            ->label(trans('plugins/sms::otp.settings.form.bodyidmessage'))
                            ->helperText(trans('plugins/sms::otp.settings.form.bodymessage_help'))
                            ->value(setting('fob_otp_bodyid',311122))
                    );
            })
