...
use FriendsOfBotble\Sms\Drivers\Melipayamak;
...
class SmsManager extends BaseManager implements Factory
{
    ...
    public function createMelipayamakDriver(): Melipayamak
    {
    ...
    {
        return setting('fob_sms_default_driver', 'melipayamak');
    }
    ...
    public function getDrivers(): array
    {
        return [
            ...
            'melipayamak' => fn () => $this->createMelipayamakDriver(),
