...
use Botble\Ecommerce\Repositories\Eloquent\DimensionRepository;
...
use Botble\Ecommerce\Repositories\Interfaces\DimensionInterface;
...
class EcommerceServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(DimensionInterface::class, function () {
            return new DimensionRepository(new Dimension());
        });
    ...
    public function boot(): void
    {
        ...
        SlugHelper::registering(function (): void {
            ...
            SlugHelper::registerModule(Dimension::class, fn () => trans('plugins/ecommerce::dimensions.dimensions'));
            ...
            SlugHelper::setPrefix(Dimension::class, 'dimensions', true);
        ...
        if (defined('LANGUAGE_MODULE_SCREEN_NAME') && defined('LANGUAGE_ADVANCED_MODULE_SCREEN_NAME')) {
            ...
            LanguageAdvancedManager::addTranslatableMetaBox('fitment-attribute-options');
            ...
            LanguageAdvancedManager::registerModule(Dimension::class, [
                'name',
                'description',
            ]);
            ...
            add_action(LANGUAGE_ADVANCED_ACTION_SAVED, function ($data, $request): void {
                switch ($data::class) {
                    ...
                    case ProductAttributeSet::class:
                        ...
                        break;
                    case SpecificationGroup::class:

                        $attributes = json_decode($request->input('name', '[]'), true) ?: [];
                        ...
                        foreach ($attributes as $item) {
                            ...
                            $attribute = SpecificationGroup::query()->find($item['id']);
                    ...
                    case SpecificationGroup::class:
                        ...
                        foreach ($attributes as $item) {
                            ...
                            $attribute = SpecificationTable::query()->find($item['id']);
        ...
        DashboardMenu::beforeRetrieving(function (): void {
            DashboardMenu::make()
                ...
                ->registerItem([
                    'id' => 'cms-plugins-dimensions',
                    'priority' => 150,
                    'parent_id' => 'cms-plugins-ecommerce',
                    'name' => 'plugins/ecommerce::dimensions.name',
                    'icon' => 'ti ti-registered',
                    'url' => fn () => route('dimensions.index'),
                    'permissions' => ['dimensions.index'],
                ])
                ->registerItem([
                ...
                ->when(EcommerceHelper::isProductFitmentEnabled(), function (DashboardMenuSupport $dashboardMenu): void {
                    $dashboardMenu
                        ->registerItem([
                            'id' => 'cms-plugins-product-fitment',
                            'priority' => 0,
                            'name' => 'plugins/ecommerce::product-fitment.product_fitment',
                            'icon' => 'ti ti-table-options',
                            'permissions' => ['ecommerce.product-fitment.index'],
                        ])
                        ->registerItem([
                            'id' => 'cms-plugins-product-fitment-groups',
                            'parent_id' => 'cms-plugins-product-fitment',
                            'priority' => 0,
                            'name' => 'plugins/ecommerce::product-fitment.fitment_groups.title',
                            'url' => fn () => route('ecommerce.fitment-groups.index'),
                            'permissions' => ['ecommerce.fitment-groups.index'],
                        ])
                        ->registerItem([
                            'id' => 'cms-plugins-product-fitment-attributes',
                            'parent_id' => 'cms-plugins-product-fitment',
                            'priority' => 10,
                            'name' => 'plugins/ecommerce::product-fitment.fitment_attributes.title',
                            'url' => fn () => route('ecommerce.fitment-attributes.index'),
                            'permissions' => ['ecommerce.fitment-attributes.index'],
                        ])
                        ->registerItem([
                            'id' => 'cms-plugins-product-fitment-tables',
                            'parent_id' => 'cms-plugins-product-fitment',
                            'priority' => 20,
                            'name' => 'plugins/ecommerce::product-fitment.fitment_tables.title',
                            'url' => fn () => route('ecommerce.fitment-tables.index'),
                            'permissions' => ['ecommerce.fitment-tables.index'],
                        ])
                        ->registerItem([
                            'id' => 'cms-plugins-product-fitment-product',
                            'parent_id' => 'cms-plugins-product-fitment',
                            'priority' => 20,
                            'name' => 'plugins/ecommerce::product-fitment.fitment_products.title',
                            'url' => fn () => route('ecommerce.fitment-products.index'),
                            'permissions' => ['ecommerce.fitment-products.index'],
                        ])
                    ;
                });
        });
