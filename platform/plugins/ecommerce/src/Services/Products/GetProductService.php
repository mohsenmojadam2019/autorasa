...
class GetProductService
{
    ...
    public function getProduct(
        ...
        $queryVar = [
            ...
            'dimensions' => (array) $request->input('dimensions', []),
            'fitments' => (array) $request->input('fitments', []),
...
//dd($queryVar);
        ...
        if ($dimension) {
            $queryVar['dimensions'] = array_merge(($queryVar['dimensions']), [$dimension]);
        }

//        if ($dimension) {
//            $queryVar['fitments'] = array_merge(($queryVar['fitments']), [$dimension]);
//        }
