...
//            )
            ...
            ->add(
                ...
                HtmlField::class,
                [
                    'html' => Html::link(route('customer.password.smsrequest'), __('Forgot password?'), attributes: ['class' => 'text-decoration-underline']),
                    'wrapper' => [
            ...
            ->submitButton(__('Login'), ['icon'=>'ti ti-arrow-narrow-right','class'=>'svgicon'])
            ->add(
                'register',
                HtmlField::class,
            ...
            ->add(
                ...
                HtmlField::class,
                HtmlFieldOption::make()
                    ->view('plugins/ecommerce::customers.includes.login-otp-link')
            )
