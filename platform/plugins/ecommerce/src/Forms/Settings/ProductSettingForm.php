...
class ProductSettingForm extends SettingForm
{
    public function setup(): void
    {
        ...
        $this
            ...
            ->add(
                'enable_product_fitment',
                OnOffCheckboxField::class,
                CheckboxFieldOption::make()
                    ->label(trans('plugins/ecommerce::setting.product.form.enable_product_fitment'))
                    ->helperText(trans('plugins/ecommerce::setting.product.form.enable_product_fitment_help'))
                    ->value(EcommerceHelper::isProductFitmentEnabled())
            )
            ->add(
