...
class ProductSearchSettingForm extends SettingForm
{
    public function setup(): void
    {
        ...
        $this
            ...
            ->add(
                ...
                MultiChecklistFieldOption::make()
                    ...
                    ->choices([
                        ...
                        'dimension' => trans('plugins/ecommerce::products.form.dimension'),
            ...
            ->add(
                'enable_filter_products_by_dimensions',
                OnOffCheckboxField::class,
                OnOffFieldOption::make()
                    ->label(trans('plugins/ecommerce::setting.product_search.form.enable_filter_products_by_dimensions'))
                    ->value(EcommerceHelper::isEnabledFilterProductsByDimensions())
                    ->defaultValue(true)
            )
            ->add(
