...
class FitmentTableTable extends TableAbstract
{
        ...
        $this
            ...
            ->addColumns([
                ...
                FormattedColumn::make('tables')
                    ->orderable(false)
                    ->label(trans('plugins/ecommerce::product-fitment.fitment_tables.fields.assigned_groups'))
    ...
    {
        return 'ecommerce.fitment-tables.create';
    }
    ...
    {
        return 'ecommerce.fitment-tables.destroy';
    }
}
