...
//dd(EcommerceHelper::getPageSlug('login'));
        Route::get('otplogin', 'OTPLoginController@showLoginForm')->name('otplogin');
        Route::post('otplogin', 'OTPLoginController@login')->name('otplogin.post');
        ...
        Route::get('/forgot-password', 'SmsForgotPasswordController@showPhoneForm')->name('password.smsrequest');
        Route::post('/forgot-password', 'SmsForgotPasswordController@sendResetCode')->name('password.sendCode');
