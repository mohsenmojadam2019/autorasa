<div>
    <x-core::form.label for="groups" class="required">
        {{ trans('plugins/ecommerce::product-fitment.fitment_tables.fields.groups') }}
    </x-core::form.label>
    ...
    <x-core::table class="mt-5">
        <x-core::table.header>
            <x-core::table.header.cell>
                {{ trans('plugins/ecommerce::product-fitment.fitment_tables.fields.name') }}
            </x-core::table.header.cell>
            <x-core::table.header.cell>
                {{ trans('plugins/ecommerce::product-fitment.fitment_tables.fields.sorting') }}
            </x-core::table.header.cell>
        </x-core::table.header>
