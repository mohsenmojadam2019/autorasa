<div class="table-responsive">
    <x-core::table class="table-bordered">
        <x-core::table.header>
            ...
            <x-core::table.header.cell class="text-center">
                {{ trans('plugins/ecommerce::product-specification.product.specification_table.show_in_card') }}
            </x-core::table.header.cell>
            <x-core::table.header.cell class="text-center">
                {{ trans('plugins/ecommerce::product-specification.product.specification_table.show_in_detail') }}
            </x-core::table.header.cell>
...
{{----}}
                        <x-core::table.body.cell class="text-center">
                            <input class="form-check-input" type="checkbox" name="specification_attributes[{{ $attribute->id }}][show_in_card]" value="1" @checked(optional($specificationAttribute)->pivot?->show_in_card)>
                        </x-core::table.body.cell>

                        <x-core::table.body.cell>
                            <input class="form-check-input" type="checkbox" name="specification_attributes[{{ $attribute->id }}][show_in_detail]" value="1" @checked(optional($specificationAttribute)->pivot?->show_in_detail)>
                        </x-core::table.body.cell>
