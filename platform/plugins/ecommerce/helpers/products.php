...
if (! function_exists('get_product_by_dimension')) {
    function get_product_by_dimension(array $params): Collection|LengthAwarePaginator|Product|null
    {
        return app(ProductInterface::class)->getProductByDimensions($params);
    }
}
