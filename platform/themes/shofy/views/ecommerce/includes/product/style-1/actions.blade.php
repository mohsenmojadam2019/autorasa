...
@if (EcommerceHelper::isCartEnabled())
    <div class="tp-product-add-cart-btn-large-wrapper">
        <button
            type="button"
            @class(['tp-product-add-cart-btn-large', 'btn-disabled' => (remain_qouta(\auth()->guard('customer')->id())<1)||($product->quantity<1)])
            ...
            @disabled((remain_qouta(\auth()->guard('customer')->id())<1) or($product->quantity<1) )
            >
