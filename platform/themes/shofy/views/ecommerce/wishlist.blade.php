                    ...
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td class="tp-cart-quantity">
                                ...
                                <div @class(['tp-product-quantity mt-10 mb-10', 'btn-disabled' => !$isMaxQtyValid]) >
                                    ...
                                    <input
                                        class="tp-cart-input"
                                        type="number"
                                        value="{{$isMaxQtyValid? 1 :$product->minimum_order_quantity}}"
                                        min="{{$isMaxQtyValid?  1:$product->minimum_order_quantity}}"
                                        name="qty"
                                        max="{{ $maxQty }}"
                                        @disabled(!$isMaxQtyValid)
                                    />
                            ...
                            <td class="tp-cart-add-to-cart">
                                <button
                                    type="submit"
                                    @class(['tp-btn tp-btn-2 tp-btn-blue', 'btn-disabled' => !$isMaxQtyValid])
