...
{{--cart--}}
                            ...
                            <x-core::form :url="route('public.coupon.apply')" method="post" id="counpon-form">
                                <div class="tp-cart-coupon-input-box">
                                    ...
                                    <div class="tp-cart-coupon-input d-flex align-items-center" >
                                        <input type="text" placeholder="{{ __('Enter Coupon Code') }}" name="coupon_code" value="{{ BaseHelper::stringify(old('coupon_code', session('applied_coupon_code'))) }}" class="ml-5"/>
                                        <button type="submit" @disabled(session('applied_coupon_code')) style="background-color: #314088 !important">{{ __('Apply') }}</button>
                                    </div>
                                </div>
                            </x-core::form>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="tp-cart-checkout-wrapper">
                        ...
                        <div class="tp-cart-checkout-proceed">
                            ...
                            @endphp
                            <a id="checkout-link" onclick="checkoutLinkAction()"  class="tp-cart-checkout-btn w-100" style="border-radius: 12px; cursor: pointer;background-color: #314088 !important ">
                                {{ __('Proceed to Checkout') }}
                            </a>
                        </div>
                        <script>
                            function checkoutLinkAction() {
                                ...
                                if (checkoutLink) {
                                    ...
                                    if (trackedStartCheckout && remainQouta >= qoutaProducts) {
                                        ...
                                        window.location.href = "{{ route('public.checkout.address', session('tracked_start_checkout')) }}";
        ...
        @else
            <div class="text-center pt-50">
                <h3 style="color: #212121 !important">{{ __('Your cart is empty') }}</h3>
                <a href="{{ route('public.products') }}" class="tp-cart-checkout-btn mt-20" style="background-color: #314088 !important ;border-radius: 12px; cursor: pointer;">{{ __('Continue Shopping') }}</a>
            </div>
        @endif
    </div>
</section>
