<header >
    <div @class(['tp-header-area p-relative z-index-11', 'tp-header-style-primary' => ! Theme::get('isHomePage')])>
        ...
        <div class="tp-header-main tp-header-sticky" style="background-color:#f9f9f9 !important; ">
            <div class="container">
                        ...
                        <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                            @if(is_plugin_active('ecommerce'))
                                <div class="tp-header-login d-none d-lg-block">
                                    <a href="{{ auth('customer')->check() ? route('customer.overview') : route('customer.register') }}" class="d-flex align-items-center">
...
{{--                                                ###--}}
                                                    {{ __('سلام, :name', ['name' => Str::limit($name, 15)]) }}
                                                @else
                                                    {{ __('Login / Register') }}
                                                @endauth
                                            </h5>
        ...
        <div
            ...
            style="background-color:#f9f9f9 !important; color: {{ theme_option('header_menu_text_color', '#010f1c') }}; border-color: {{ theme_option('header_border_color', 'rgba(1, 15, 28, 0.1)') }};"
        >
            <div class="container">
