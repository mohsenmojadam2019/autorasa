    ...
    >
        <div @class(['container' => $breadcrumbStyle !== 'full-width', 'container-fluid' => $breadcrumbStyle === 'full-width'])>
            <div class="breadcrumb__content p-relative z-index-1">
                ...
                @endif
                <div style=".breadcrumb__list=font-size: 14px !important;padding-top: 5px" @class([

    'text-[14px]', // اضافه شده
    'js_breadcrumb_reduce_length_on_mobile' => theme_option('breadcrumb_reduce_length_on_mobile', 'yes') == 'yes',
])>
