<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 d-flex justify-content-center">
                ...
                @if($config['show_social_links'] && $socialLinks = Theme::getSocialLinks())
                    <div class="tp-footer-social">
                        @foreach($socialLinks as $socialLink)
                            ...
                            <a style="margin: 6px !important;" {!! $socialLink->getAttributes() !!}>{{ $socialLink->getIconHtml() }}</a>
                        @endforeach
                    </div>
                @endif
            </div>
